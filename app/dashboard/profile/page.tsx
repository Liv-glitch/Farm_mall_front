...
import { Edit, User, MapPin, Mail, Phone, Calendar, Shield, ShoppingBag } from "lucide-react"
            ...
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">Manage your marketplace listing and account information</p>
                </div>
              </div>
              {activeTab === "account" ? (
                <Button

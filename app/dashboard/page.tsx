...
import { Plus, User, Edit, ShoppingBag } from "lucide-react"
      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <main className="container mx-auto px-4 py-8">
          <div className="max-w-6xl mx-auto">
            {/* Welcome Message with Market Button */}
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                <h1 className="text-3xl font-bold text-agri-800">
                  {hasCycles ? `Welcome back, ${firstName}!` : `Welcome, ${firstName}!`}
                </h1>
                <p className="text-gray-600 mt-1">Manage your farming activities and find market opportunities</p>
              </div>
              
              {/* New Find Market Button */}
              <a 

    ...
    <>
      <div className="mx-auto grid w-full max-w-5xl grid-cols-1 gap-5">
        {farmTools.map((tool) => (
          ...
          >
            <CardContent className="flex w-full flex-col items-center gap-5 px-6 pb-6 pt-8 text-center">
              ...
              <Button
                type="button"
                className="w-full bg-agri-700 text-white hover:bg-agri-800 sm:w-56"
                onClick={(event) => {

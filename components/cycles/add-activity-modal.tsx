  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "New activity has been added to your farm preparation record",
      })
    } catch (error: any) {
      toast({
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[95vh] overflow-y-auto p-0 gap-0">
        <DialogHeader className="p-4 sm:p-6 sticky top-0 bg-white border-b">
          ...
          <DialogDescription>
            Add a new activity to your farm preparation record. You can use predefined templates or create a custom activity.
          </DialogDescription>
        </DialogHeader>
